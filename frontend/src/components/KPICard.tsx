  ...
  return (
    <div className="relative group">
      ...
      <div className={`relative bg-white/70 backdrop-blur-xl rounded-2xl p-6 border border-white/40 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] ${colors.bg}`}>
        ...
        <div className={`absolute inset-0 bg-gradient-to-r ${colors.gradient} rounded-2xl opacity-0 group-hover:opacity-20 blur-sm transition-opacity duration-300 -z-10`} />
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-1">
            ...
            <div className={`text-3xl font-bold ${colors.text} bg-gradient-to-r ${colors.gradient} bg-clip-text text-transparent`}>
              {value}
            </div>
            {subtitle && (
